// ProfileSidebar.tsx
// Requirements: shadcn/ui, Geist font (installed via `npm i geist`)
// Tailwind config must include the Geist font family.
// Add to tailwind.config: fontFamily: { geist: ['var(--font-geist-sans)'] }
// In layout.tsx import { GeistSans } from 'geist/font/sans' and apply className
