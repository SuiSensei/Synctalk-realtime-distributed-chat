...
export function NewChatDropdown() {
  return (
    <DropdownMenu>
      ...
      >
        {}
        <DropdownMenuItem className="p-0 cursor-pointer rounded-[4px] focus:!bg-[#2A2A2A] data-[highlighted]:!bg-[#2A2A2A] focus:!text-[#F3F4F6] data-[highlighted]:!text-[#F3F4F6] focus:[&_*]:!text-[#F3F4F6] data-[highlighted]:[&_*]:!text-[#F3F4F6] transition-colors">
